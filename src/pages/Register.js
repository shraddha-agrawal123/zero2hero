...
const navigateToLogin = () => {
  ...
  // For Next.js: use router.push('/login')
    ...
    <div className="illustration-container">
      <div className="floating-elements">
        ...
        <div className="hero-text">
          ...
          <p className="hero-subtitle">Join the Revolution</p>
          <div className="stats">
            <div className="stat">
        ...
        <div className="form-side">
          <div className="auth-card">
            <div className="brand-header">
              ...
              <p className="brand-subtitle">Join the Revolution</p>
            </div>
            ...
            <div className="form-container">
              ...
              <div>
                ...
                <div className="auth-switch">
                  Already have an account? <button type="button" onClick={navigateToLogin} className="auth-link">Sign In</button>
                </div>
              </div>
            </div>
          </div>
